...
#define LCD_XRES	(720)
#define LCD_YRES	(1280)
#elif defined(CONFIG_LCD_CMI_OTM1282B)
#define LCD_XRES	(720)
#define LCD_YRES	(1280)
...
#else
#define HISI_MEM_CODEC_SIZE	(64 * SZ_1M) //49
#endif
...
#define HISI_PMEM_GRALLOC_SIZE  (160 * SZ_1M) //133
#else
#define HISI_PMEM_GRALLOC_SIZE	(160 * SZ_1M) //135
#endif
#endif

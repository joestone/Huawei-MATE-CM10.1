...
public class MateRIL extends RIL implements CommandsInterface {
    ...
    public MateRIL(Context context, int networkMode, int cdmaSubscription) {
...
//We get dBm values from ril(-51dB -> -113dB) , but we have to give asu parameter (0-31)
// on 2G mode position 0 (gsmSignalStrength) contains this value , while in 3G position 2(CdmaDbm) . We always send the value in position 0.		
